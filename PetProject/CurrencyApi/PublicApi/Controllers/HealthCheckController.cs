...
public class HealthCheckController : ControllerBase
{
    ...
    public async Task<HealthCheckResult> Check(bool? checkExternalApi, CancellationToken cancellationToken)
    {
        ...
        {
            var response =
                await _healthClient.CheckAsync(new HealthCheckRequest(), cancellationToken: cancellationToken);
        ...
        {
            return new HealthCheckResult { CheckedOn = DateTimeOffset.Now, Status = CheckStatus.Failed };
        }
    }
}
